...
import com.movie.myapplication.controller.EventItemLongClickListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // start a AsyncTask to get all data from database
        ...
        inItems = items;
        eventListView.setOnItemLongClickListener(new EventItemLongClickListener(this, inItems));
