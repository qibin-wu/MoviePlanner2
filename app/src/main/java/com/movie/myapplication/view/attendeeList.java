...
import com.movie.myapplication.controller.attendeeOnItemLongClick;
...
public class attendeeList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        attendeeListView.setOnItemLongClickListener(new attendeeOnItemLongClick(this,attendees,thisEvent));
    }
